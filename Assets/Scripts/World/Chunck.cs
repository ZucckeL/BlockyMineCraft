...
public class Chunck : NetworkBehaviour
{	
    public Block[, ,] map;
	...
	public GameObject sundriesPrefab;
    public bool isTree;
    int Tmp;
    ...
    public Block GetTheoreticalBlock(Vector3 pos)
    {
        ...
        noiseValue += (200 - (float)pos.y) / 16f;
        noiseValue /= (float)pos.y / 8f;

        cavernas /= (float)pos.y / 16f;
        cavernas /= 2;
...
public class Block
{
    ...
    public Block(string name, bool transparent, int tX, int tY,int hp)
    {
    ...
    public Block(string name, bool transparent, int tX, int tY, int sX, int sY,int hp)
    {
        Trasnsparent = transparent;
        BlockName = name;
        BlockID = BlockList.Blocks.Count;
    ...
    public Block(string name, bool transparent, int tX, int tY, int sX, int sY, int bX, int bY,int hp)
    {
        Trasnsparent = transparent;
        BlockName = name;
        BlockID = BlockList.Blocks.Count;
